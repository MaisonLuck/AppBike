...
export default function App() {
  return (
    ...
    <View style={styles.container}>
        ...
        <Image
          source ={require("./assets/dark-bike@2x.png")}
          resizeMode="center"
          style={{position:"relative", top: 20, right:45}}
        />
        <Image
          source ={require("./assets/dark-bike@3x.png")}
          resizeMode="center"
      ...
      <Image
          ...
          source ={require("./assets/bike@2x.png")}
          style={styles.produtos}
        />
      ...
      <View style={styles.boxProdutos}>
      <Image
          source ={require("./assets/bike@3x.png")}
      ...
      <View style={styles.boxProdutos}>
      <Image
          source ={require("./assets/dark-bike.png")}
          style={styles.produtos}
        />
